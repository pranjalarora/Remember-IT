...
class Main extends Component{
    ...
    render(){
        return(
            ...
            <>
                <div className="hi">
                <center><strong>Remember-it</strong></center>
                </div>
       <center><HomeCarousel/></center>
       <div className="container">
           <div className="row">
               <div className="col-md-4 mt-md-5">
                <h3><strong>Remember-it helps teams work more collaboratively and get more done</strong></h3><br/>
                <p>Remeber-it's boards, lists, and cards enable teams to organize and prioritize projects in a fun, flexible, and rewarding way.</p><br/>
